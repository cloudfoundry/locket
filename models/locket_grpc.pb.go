...
func RegisterProtoLocketServer(s grpc.ServiceRegistrar, srv ProtoLocketServer) {
	// If the following call panics, it indicates UnimplementedProtoLocketServer was
