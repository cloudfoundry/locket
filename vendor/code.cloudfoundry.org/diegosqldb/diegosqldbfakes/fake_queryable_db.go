...
type FakeQueryableDB struct {
	BeginTxStub        func(context.Context, *sql.TxOptions) (diegosqldb.Tx, error)
	...
	QueryRowContextStub        func(context.Context, string, ...interface{}) diegosqldb.RowScanner
...
func (fake *FakeQueryableDB) BeginTx(arg1 context.Context, arg2 *sql.TxOptions) (diegosqldb.Tx, error) {
...
func (fake *FakeQueryableDB) BeginTxCalls(stub func(context.Context, *sql.TxOptions) (diegosqldb.Tx, error)) {
	fake.beginTxMutex.Lock()
...
func (fake *FakeQueryableDB) BeginTxReturns(result1 diegosqldb.Tx, result2 error) {
	fake.beginTxMutex.Lock()
	defer fake.beginTxMutex.Unlock()
...
func (fake *FakeQueryableDB) BeginTxReturnsOnCall(i int, result1 diegosqldb.Tx, result2 error) {
	fake.beginTxMutex.Lock()
	defer fake.beginTxMutex.Unlock()
	fake.BeginTxStub = nil
...
func (fake *FakeQueryableDB) QueryRowContext(arg1 context.Context, arg2 string, arg3 ...interface{}) diegosqldb.RowScanner {
...
func (fake *FakeQueryableDB) QueryRowContextCalls(stub func(context.Context, string, ...interface{}) diegosqldb.RowScanner) {
	fake.queryRowContextMutex.Lock()
...
func (fake *FakeQueryableDB) QueryRowContextReturns(result1 diegosqldb.RowScanner) {
	fake.queryRowContextMutex.Lock()
	defer fake.queryRowContextMutex.Unlock()
...
func (fake *FakeQueryableDB) QueryRowContextReturnsOnCall(i int, result1 diegosqldb.RowScanner) {
	fake.queryRowContextMutex.Lock()
	defer fake.queryRowContextMutex.Unlock()
	fake.QueryRowContextStub = nil
...
var _ diegosqldb.QueryableDB = new(FakeQueryableDB)
